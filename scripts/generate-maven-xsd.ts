...
const getSchema = () => {
	return {
		project: {
			...
			reports: {
				...complexTypeElement(M400, DESC.project_reports),
				$deprecated: true,
			},
...
function IssueManagement(version?: string, description?: string) {
	return {
		...
		$documentation: new Documentation(
			version ?? M400,
			description ?? DESC.IssueManagement,
		),
...
function DistributionManagement(version?: string, description?: string) {
	return {
		...
		$documentation: new Documentation(
			version ?? M400,
			description ?? DESC.DistributionManagement,
		),
...
function DeploymentRepository(version?: string, description?: string) {
	return {
		...
		$documentation: new Documentation(
			version ?? M400,
			description ?? DESC.DeploymentRepository,
		),
		// TODO:
...
function DependencyManagement(version?: string, description?: string) {
	return {
		...
		$documentation: new Documentation(
			version ?? M400,
			description ?? DESC.DependencyManagement,
		),
...
function RepositoryPolicy(version?: string, description?: string) {
	return {
		...
		$documentation: new Documentation(
			version ?? M400,
			description ?? DESC.RepositoryPolicy,
		),
...
function PluginManagement(version: string, description: string) {
	return {
		...
		$documentation: new Documentation(
			version ?? M400,
			description ?? DESC.PluginManagement,
		),
...
function ActivationProperty(version?: string, description?: string) {
	return {
		...
		$documentation: new Documentation(
			version ?? M400,
			description ?? DESC.ActivationProperty,
		),
...
function ActivationFile(version?: string, description?: string) {
	return {
		...
		$documentation: new Documentation(
			version ?? M400,
			description ?? DESC.ActivationFile,
		),

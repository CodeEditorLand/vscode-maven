...
exports.generateMavenDef = void 0;
var fs_1 = require("fs");
var path = require("path");
function generateMavenDef() {
...
var DESC = {
	...
	Parent_relativePath:
		" The relative path of the parent <code>pom.xml</code> file within the check out. If not specified, it defaults to <code>../pom.xml</code>. Maven looks for the parent POM first in this location on the filesystem, then the local repository, and lastly in the remote repo. <code>relativePath</code> allows you to select a different location, for example when your structure is flat, or deeper without an intermediate parent POM. However, the group ID, artifact ID and version are still required, and must match the file in the location given or it will revert to the repository for the POM. This feature is only for enhancing the development in a local checkout of that project. Set the value to an empty string in case you want to disable the feature and always resolve the parent POM from the repositories. ",
	...
	License_distribution:
		" The primary method by which this project may be distributed. <dl> <dt>repo</dt> <dd>may be downloaded from the Maven repository</dd> <dt>manual</dt> <dd>user must manually download and install the dependency.</dd> </dl> ",
	...
	Developer_timezone:
		' The timezone the contributor is in. Typically, this is a number in the range <a href="http://en.wikipedia.org/wiki/UTC%E2%88%9212:00">-12</a> to <a href="http://en.wikipedia.org/wiki/UTC%2B14:00">+14</a> or a valid time zone id like "America/Montreal" (UTC-05:00) or "Europe/Paris" (UTC+01:00). ',
	...
	MailingList_subscribe:
		" The email address or link that can be used to subscribe to the mailing list. If this is an email address, a <code>mailto:</code> link will automatically be created when the documentation is created. ",
	MailingList_unsubscribe:
		" The email address or link that can be used to unsubscribe to the mailing list. If this is an email address, a <code>mailto:</code> link will automatically be created when the documentation is created. ",
	MailingList_post:
		" The email address or link that can be used to post to the mailing list. If this is an email address, a <code>mailto:</code> link will automatically be created when the documentation is created. ",
	MailingList_archive:
	...
	Scm_developerConnection:
		' Just like <code>connection</code>, but for developers, i.e. this scm connection will not be read only. <br><b>Default value is</b>: parent value [+ path adjustment] + (artifactId or project.directory property), or just parent value if scm\'s <code>child.scm.developerConnection.inherit.append.path="false"</code> ',
	Scm_tag:
		"The tag of current code. By default, it's set to HEAD during development.",
	Scm_url:
		" The URL to the project's browsable SCM repository, such as ViewVC or Fisheye. <br><b>Default value is</b>: parent value [+ path adjustment] + (artifactId or project.directory property), or just parent value if scm's <code>child.scm.url.inherit.append.path=\"false\"</code> ",
	Scm_childScmConnectionInheritAppendPath:
		" When children inherit from scm connection, append path or not? Note: While the type of this field is <code>String</code> for technical reasons, the semantic type is actually <code>Boolean</code> <br><b>Default value is</b>: <code>true</code> <br><b>Since</b>: Maven 3.6.1 ",
	Scm_childScmDeveloperConnectionInheritAppendPath:
		" When children inherit from scm developer connection, append path or not? Note: While the type of this field is <code>String</code> for technical reasons, the semantic type is actually <code>Boolean</code> <br><b>Default value is</b>: <code>true</code> <br><b>Since</b>: Maven 3.6.1 ",
	Scm_childScmUrlInheritAppendPath:
		" When children inherit from scm url, append path or not? Note: While the type of this field is <code>String</code> for technical reasons, the semantic type is actually <code>Boolean</code> <br><b>Default value is</b>: <code>true</code> <br><b>Since</b>: Maven 3.6.1 ",
	IssueManagement:
		"Information about the issue tracking (or bug tracking) system used to manage this project.",
	IssueManagement_system:
	...
	DistributionManagement_repository:
		"Information needed to deploy the artifacts generated by the project to a remote repository.",
	DistributionManagement_snapshotRepository:
		" Where to deploy snapshots of artifacts to. If not given, it defaults to the <code>repository</code> element.",
	DistributionManagement_site:
		"Information needed for deploying the web site of the project.",
	DistributionManagement_downloadUrl:
		" The URL of the project's download page. If not given users will be referred to the homepage given by <code>url</code>. This is given to assist in locating artifacts that are not in the repository due to licensing restrictions. ",
	DistributionManagement_relocation:
		"Relocation information of the artifact if it has been moved to a new group ID and/or artifact ID.",
	DistributionManagement_status:
	...
	DependencyManagement_dependencies:
	...
	Dependency_optional:
		" Indicates the dependency is optional for use of this library. While the version of the dependency will be taken into account for dependency calculation if the library is used elsewhere, it will not be passed on transitively. Note: While the type of this field is <code>String</code> for technical reasons, the semantic type is actually <code>Boolean</code>. Default value is <code>false</code>. ",
	Exclusion:
	...
	Site_id:
		" A unique identifier for a deployment location. This is used to match the site to configuration in the <code>settings.xml</code> file, for example.",
	Site_name: "Human readable name of the deployment location.",
	Site_url:
		' The url of the location where website is deployed, in the form <code>protocol://hostname/path</code>. <br><b>Default value is</b>: parent value [+ path adjustment] + (artifactId or project.directory property), or just parent value if site\'s <code>child.site.url.inherit.append.path="false"</code> ',
	Profile:
	...
	Profile_distributionManagement:
	...
	Repository_id:
		" A unique identifier for a repository. This is used to match the repository to configuration in the <code>settings.xml</code> file, for example. Furthermore, the identifier is used during POM inheritance and profile injection to detect repositories that should be merged. ",
	...
	Reporting_excludeDefaults:
		' If true, then the default reports are not included in the site generation. This includes the reports in the "Project Info" menu. Note: While the type of this field is <code>String</code> for technical reasons, the semantic type is actually <code>Boolean</code>. Default value is <code>false</code>. ',
	Reporting_outputDirectory:
	...
	ReportPlugin_reportSets:
		" Multiple specifications of a set of reports, each having (possibly) different configuration. This is the reporting parallel to an <code>execution</code> in the build. ",
	ReportPlugin_inherited:
		" Whether any configuration should be propagated to child POMs. Note: While the type of this field is <code>String</code> for technical reasons, the semantic type is actually <code>Boolean</code>. Default value is <code>true</code>. ",
	ReportPlugin_configuration:
	...
	Build_scriptSourceDirectory:
		" This element specifies a directory containing the script sources of the project. This directory is meant to be different from the sourceDirectory, in that its contents will be copied to the output directory in most cases (since scripts are interpreted rather than compiled). The default value is <code>src/main/scripts</code>. ",
	Build_testSourceDirectory:
	...
	Build_resources:
		" This element describes all of the classpath resources such as properties files associated with a project. These resources are often included in the final package. The default value is <code>src/main/resources</code>. ",
	Build_testResources:
		" This element describes all of the classpath resources such as properties files associated with a project's unit tests. The default value is <code>src/test/resources</code>. ",
	Build_directory:
	...
	BuildBase_defaultGoal:
		"The default goal (or phase in Maven 2) to execute when none is specified for the project. Note that in case of a multi-module build, only the default goal of the top-level project is relevant, i.e. the default goals of child modules are ignored. Since Maven 3, multiple goals/phases can be separated by whitespace.",
	BuildBase_resources:
		" This element describes all of the classpath resources such as properties files associated with a project. These resources are often included in the final package. The default value is <code>src/main/resources</code>. ",
	BuildBase_testResources:
		" This element describes all of the classpath resources such as properties files associated with a project's unit tests. The default value is <code>src/test/resources</code>. ",
	BuildBase_directory:
		" The directory where all files generated by the build are placed. The default value is <code>target</code>. ",
	BuildBase_finalName:
	...
	Resource_filtering:
		" Whether resources are filtered to replace tokens with parameterised values or not. The values are taken from the <code>properties</code> element and from the properties in the files listed in the <code>filters</code> element. Note: While the type of this field is <code>String</code> for technical reasons, the semantic type is actually <code>Boolean</code>. Default value is <code>false</code>. ",
	Resource_directory:
	...
	PluginExecution_inherited:
		" Whether any configuration should be propagated to child POMs. Note: While the type of this field is <code>String</code> for technical reasons, the semantic type is actually <code>Boolean</code>. Default value is <code>true</code>. ",
	PluginExecution_configration:
		' <p>The configuration as DOM object.</p> <p>By default, every element content is trimmed, but starting with Maven 3.1.0, you can add <code>xml:space="preserve"</code> to elements you want to preserve whitespace.</p> <p>You can control how child POMs inherit configuration from parent POMs by adding <code>combine.children</code> or <code>combine.self</code> attributes to the children of the configuration element:</p> <ul> <li><code>combine.children</code>: available values are <code>merge</code> (default) and <code>append</code>,</li> <li><code>combine.self</code>: available values are <code>merge</code> (default) and <code>override</code>.</li> </ul> <p>See <a href="https://maven.apache.org/pom.html#Plugins">POM Reference documentation</a> and <a href="https://codehaus-plexus.github.io/plexus-utils/apidocs/org/codehaus/plexus/util/xml/Xpp3DomUtils.html">Xpp3DomUtils</a> for more information.</p> ',
	ActivationProperty:
	...
	ActivationProperty_name:
		"The name of the property to be used to activate a profile.",
	ActivationProperty_value:
	...
	ActivationFile_missing:
		"The name of the file that must be missing to activate the profile.",
	ActivationFile_exists:
		"The name of the file that must exist to activate the profile.",
	ActivationOS:
		"This is an activator which will detect an operating system's attributes in order to activate its profile.",
	ActivationOS_name:
		" The name of the operating system to be used to activate the profile. This must be an exact match of the <code>${os.name}</code> Java property, such as <code>Windows XP</code>. ",
	ActivationOS_family:
	...
	ActivationOS_version:
		"The version of the operating system to be used to activate the profile.",
	RepositoryPolicy: "Download policy.",
	RepositoryPolicy_enabled:
		" Whether to use this repository for downloading this type of artifact. Note: While the type of this field is <code>String</code> for technical reasons, the semantic type is actually <code>Boolean</code>. Default value is <code>true</code>. ",
	RepositoryPolicy_updatePolicy:
		" The frequency for downloading updates - can be <code>always,</code> <code>daily</code> (default), <code>interval:XXX</code> (in minutes) or <code>never</code> (only if it doesn't exist locally). ",
	RepositoryPolicy_checksumPolicy:
		" What to do when verification of an artifact checksum fails. Valid values are <code>ignore</code> , <code>fail</code> or <code>warn</code> (the default).",
	// project
	project:
	...
	project_url:
		" The URL to the project's homepage. <br><b>Default value is</b>: parent value [+ path adjustment] + (artifactId or project.directory property), or just parent value if project's <code>child.project.url.inherit.append.path=\"false\"</code> ",
...
var getSchema = function () {
	return {
		project: {
			...
			pluginRepositories: complexTypeElement(
				M400,
				DESC.project_pluginRepositories,
				{
			...
			reports: __assign(
				__assign({}, complexTypeElement(M400, DESC.project_reports)),
				{ $deprecated: true },
			),
...
function booleanElement(version, description, _default) {
	return {
		$type: "xs:string",
...
function stringElement(version, description, _default) {
	return {
		$type: "xs:string",
		$documentation: new Documentation(version, description),
		$default: _default,
...
function deprecatedElement(version, description) {
	return {
		$type: "xs:deprecated",
		$documentation: new Documentation(version, description),
		$deprecated: true,
...
function complexTypeElement(version, description, children, typeName) {
	if (children === void 0) {
		children = {};
	}
	if (typeName === void 0) {
...
function Parent(version, description) {
	return {
		$type: "Parent",
		$documentation: new Documentation(
			version !== null && version !== void 0 ? version : M400,
...
function Organization(version, description) {
	return {
		$type: "Organization",
		$documentation: new Documentation(
			version !== null && version !== void 0 ? version : M300,
			description !== null && description !== void 0
				? description
				: DESC.Organization,
		),
...
function License(version, description) {
	return {
		$type: "License",
		$documentation: new Documentation(
			version !== null && version !== void 0 ? version : M300,
...
function Developer(version, description) {
	return {
		$type: "Developer",
		$documentation: new Documentation(
			version !== null && version !== void 0 ? version : M300,
...
function Contributor(version, description) {
	return {
		$type: "Contributor",
		$documentation: new Documentation(
			version !== null && version !== void 0 ? version : M300,
...
function MailingList(version, description) {
	return {
		$type: "MailingList",
		$documentation: new Documentation(
			version !== null && version !== void 0 ? version : M300,
		...
		otherArchives: complexTypeElement(
			M300,
			DESC.MailingList_otherArchives,
			{
...
function Prerequisites(version, description) {
	return {
		$type: "Prerequisites",
		$documentation: new Documentation(
			version !== null && version !== void 0 ? version : M400,
...
function Scm(version, description) {
	return {
		$type: "Scm",
		$documentation: new Documentation(
			version !== null && version !== void 0 ? version : M400,
		...
		childScmConnectionInheritAppendPath: stringElement(
			M400,
			DESC.Scm_childScmConnectionInheritAppendPath,
		),
		childScmDeveloperConnectionInheritAppendPath: stringElement(
			M400,
			DESC.Scm_childScmDeveloperConnectionInheritAppendPath,
		),
		childScmUrlInheritAppendPath: stringElement(
			M400,
			DESC.Scm_childScmUrlInheritAppendPath,
		),
	};
}
function IssueManagement(version, description) {
	return {
...
function DistributionManagement(version, description) {
	return {
		...
		$documentation: new Documentation(
			...
			description !== null && description !== void 0
				? description
				: DESC.DistributionManagement,
		),
		repository: DeploymentRepository(
			M400,
			DESC.DistributionManagement_repository,
		),
		snapshotRepository: DeploymentRepository(
			M400,
			DESC.DistributionManagement_snapshotRepository,
		),
		site: Site(M400, DESC.DistributionManagement_site),
		downloadUrl: stringElement(
			M400,
			DESC.DistributionManagement_downloadUrl,
		),
...
function Notifier() {
	return {
		...
		configuration: complexTypeElement(
			M000,
			DESC.Notifier_configuration,
			{},
		),
	};
}
function DeploymentRepository(version, description) {
	return {
		...
		$documentation: new Documentation(
			...
			description !== null && description !== void 0
				? description
				: DESC.DeploymentRepository,
		),
	};
}
function Relocation(version, description) {
	return {
		$type: "Relocation",
		$documentation: new Documentation(
			version !== null && version !== void 0 ? version : M400,
...
function Site(version, description) {
	return {
		$type: "Site",
		$documentation: new Documentation(
			version !== null && version !== void 0 ? version : M400,
...
function DependencyManagement(version, description) {
	return {
		...
		$documentation: new Documentation(
			...
			description !== null && description !== void 0
				? description
				: DESC.DependencyManagement,
		),
		dependencies: complexTypeElement(
			M400,
			DESC.DependencyManagement_dependencies,
			{
				dependency: Dependency(),
			},
		),
...
function Build(version, description) {
	return {
		$type: "Build",
		$documentation: new Documentation(
			version !== null && version !== void 0 ? version : M300,
		...
		scriptSourceDirectory: stringElement(
			M400,
			DESC.Build_scriptSourceDirectory,
		),
		testSourceDirectory: stringElement(
			M400,
			DESC.Build_testSourceDirectory,
		),
		outputDirectory: stringElement(M400, DESC.Build_outputDirectory),
		testOutputDirectory: stringElement(
			M400,
			DESC.Build_testOutputDirectory,
		),
...
function Reporting(version, description) {
	return {
		$type: "Reporting",
		$documentation: new Documentation(
			version !== null && version !== void 0 ? version : M400,
...
function Profile() {
	return {
		...
		distributionManagement: DistributionManagement(
			M400,
			DESC.Profile_distributionManagement,
		),
		properties: complexTypeElement(M400, DESC.Profile_properties),
		dependencyManagement: DependencyManagement(
			M400,
			DESC.Profile_dependencyManagement,
		),
		...
		pluginRepositories: complexTypeElement(
			M400,
			DESC.Profile_pluginRepositories,
			{
				repository: Repository(),
			},
		),
...
function Activation(version, description) {
	return {
		$type: "Activation",
		$documentation: new Documentation(
			version !== null && version !== void 0 ? version : M400,
		...
		activeByDefault: booleanElement(
			M400,
			DESC.Activation_activeByDefault,
			"false",
		),
...
function BuildBase(version, description) {
	return {
		$type: "BuildBase",
		$documentation: new Documentation(
			version !== null && version !== void 0 ? version : M300,
		...
		pluginManagement: PluginManagement(
			M400,
			DESC.BuildBase_pluginManagement,
		),
...
function RepositoryPolicy(version, description) {
	return {
		...
		checksumPolicy: stringElement(
			M400,
			DESC.RepositoryPolicy_checksumPolicy,
		),
	};
}
function ReportPlugin() {
	return {
		...
		configuration: complexTypeElement(
			M400,
			DESC.ReportPlugin_configuration,
		),
	};
}
function ReportSet() {
...
function PluginManagement(version, description) {
	return {
...
function PluginExecution() {
	return {
		...
		configuration: complexTypeElement(
			M000,
			DESC.PluginExecution_configration,
		),
	};
}
function ActivationProperty(version, description) {
	return {
...
function ActivationOS(version, description) {
	return {
		$type: "ActivationOS",
		$documentation: new Documentation(
			version !== null && version !== void 0 ? version : M400,

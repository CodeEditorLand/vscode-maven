...
function generateMavenDef() {
    ...
    (0, fs_1.writeFileSync)(path.join(dir, "maven-4.0.0.xsd.json"), JSON.stringify(schema, null, 2));
...
var getSchema = function () {
    return {
        project: {
            ...
            reports: __assign(__assign({}, complexTypeElement(M400, DESC.project_reports)), { $deprecated: true }),
...
function complexTypeElement(version, description, children, typeName) {
    ...
    if (typeName === void 0) { typeName = "complexType"; }
    return __assign({ $type: typeName, $documentation: new Documentation(version, description) }, children);
}
function Parent(version, description) {
    return {
        $type: "Parent",
        $documentation: new Documentation(version !== null && version !== void 0 ? version : M400, description !== null && description !== void 0 ? description : DESC.Parent),
...
function Organization(version, description) {
    return {
        $type: "Organization",
        $documentation: new Documentation(version !== null && version !== void 0 ? version : M300, description !== null && description !== void 0 ? description : DESC.Organization),
...
function License(version, description) {
    return {
        $type: "License",
        $documentation: new Documentation(version !== null && version !== void 0 ? version : M300, description !== null && description !== void 0 ? description : DESC.License),
...
function Developer(version, description) {
    return {
        $type: "Developer",
        $documentation: new Documentation(version !== null && version !== void 0 ? version : M300, description !== null && description !== void 0 ? description : DESC.Developer),
...
function Contributor(version, description) {
    return {
        $type: "Contributor",
        $documentation: new Documentation(version !== null && version !== void 0 ? version : M300, description !== null && description !== void 0 ? description : DESC.Contributor),
...
function MailingList(version, description) {
    return {
        $type: "MailingList",
        $documentation: new Documentation(version !== null && version !== void 0 ? version : M300, description !== null && description !== void 0 ? description : DESC.MailingList),
...
function Prerequisites(version, description) {
    return {
        $type: "Prerequisites",
        $documentation: new Documentation(version !== null && version !== void 0 ? version : M400, description !== null && description !== void 0 ? description : DESC.Prerequisites),
...
function Scm(version, description) {
    return {
        $type: "Scm",
        $documentation: new Documentation(version !== null && version !== void 0 ? version : M400, description !== null && description !== void 0 ? description : DESC.Scm),
        maven: stringElement(M400, DESC.Prerequisites_maven, "2.0"),
...
function IssueManagement(version, description) {
    return {
        ...
        $documentation: new Documentation(version !== null && version !== void 0 ? version : M400, description !== null && description !== void 0 ? description : DESC.IssueManagement),
...
function CiManagement(version, description) {
    return {
        $type: "CiManagement",
        $documentation: new Documentation(version !== null && version !== void 0 ? version : M400, description !== null && description !== void 0 ? description : DESC.CiManagement),
...
function DeploymentRepository(version, description) {
    return {
        ...
        $documentation: new Documentation(version !== null && version !== void 0 ? version : M400, description !== null && description !== void 0 ? description : DESC.DeploymentRepository)
    };
}
function Relocation(version, description) {
    return {
        $type: "Relocation",
        $documentation: new Documentation(version !== null && version !== void 0 ? version : M400, description !== null && description !== void 0 ? description : DESC.Relocation),
...
function Site(version, description) {
    return {
        $type: "Site",
        $documentation: new Documentation(version !== null && version !== void 0 ? version : M400, description !== null && description !== void 0 ? description : DESC.Site),
...
function DependencyManagement(version, description) {
    return {
        ...
        $documentation: new Documentation(version !== null && version !== void 0 ? version : M400, description !== null && description !== void 0 ? description : DESC.DependencyManagement),
...
function Build(version, description) {
    return {
        $type: "Build",
        $documentation: new Documentation(version !== null && version !== void 0 ? version : M300, description !== null && description !== void 0 ? description : DESC.Build),
...
function Reporting(version, description) {
    return {
        $type: "Reporting",
        $documentation: new Documentation(version !== null && version !== void 0 ? version : M400, description !== null && description !== void 0 ? description : DESC.Reporting),
...
function Activation(version, description) {
    return {
        $type: "Activation",
        $documentation: new Documentation(version !== null && version !== void 0 ? version : M400, description !== null && description !== void 0 ? description : DESC.Activation),
...
function BuildBase(version, description) {
    return {
        $type: "BuildBase",
        $documentation: new Documentation(version !== null && version !== void 0 ? version : M300, description !== null && description !== void 0 ? description : DESC.BuildBase),
...
function RepositoryPolicy(version, description) {
    return {
        ...
        $documentation: new Documentation(version !== null && version !== void 0 ? version : M400, description !== null && description !== void 0 ? description : DESC.RepositoryPolicy),
...
function PluginManagement(version, description) {
    return {
        ...
        $documentation: new Documentation(version !== null && version !== void 0 ? version : M400, description !== null && description !== void 0 ? description : DESC.PluginManagement),
...
function ActivationProperty(version, description) {
    return {
        ...
        $documentation: new Documentation(version !== null && version !== void 0 ? version : M400, description !== null && description !== void 0 ? description : DESC.ActivationProperty),
...
function ActivationFile(version, description) {
    return {
        $type: "ActivationProperty",
        $documentation: new Documentation(version !== null && version !== void 0 ? version : M400, description !== null && description !== void 0 ? description : DESC.ActivationFile),
...
function ActivationOS(version, description) {
    return {
        $type: "ActivationOS",
        $documentation: new Documentation(version !== null && version !== void 0 ? version : M400, description !== null && description !== void 0 ? description : DESC.ActivationOS),

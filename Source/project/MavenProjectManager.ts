...
export class MavenProjectManager {
	...
	public static get projects(): MavenProject[] {
		return Array.from(
			MavenProjectManager.getInstance()._projectMap.values()
		);
	}
	...
	public static update(...items: MavenProject[]): void {
		for (const item of items) {
			MavenProjectManager.getInstance()._projectMap.set(
				item.pomPath,
				item
			);
		}
	...
	public static async removeAllFrom(
